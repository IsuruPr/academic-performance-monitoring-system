                        ...
                        >
                            ...
                            <div className="mt-5 grid grid-cols-2 gap-4 relative z-10">
                                <div className="rounded-xl bg-[#232323] p-3 border border-[#333333] shadow-sm text-center">
                                    ...
                                    <div className={`mt-0.5 text-[8px] font-black uppercase tracking-widest ${s.caSource === "db" ? "text-emerald-400" : s.caSource === "profile" ? "text-blue-400" : "text-amber-400/70"}`}>
                            ...
                            <div className="mt-5 flex gap-2 relative z-10">
                                <button
                                    ...
                                    className="flex-1 rounded-xl bg-[#22c55e] border border-[#22c55e] px-4 py-2.5 text-sm font-bold text-black transition-all hover:bg-[#16a34a] shadow-sm hover:shadow uppercase tracking-wider"
                                >
                                    Simulate
                                </button>
                                <button
                                    onClick={() => onStudyPlan?.(s)}
                                    title="Generate AI Study Plan"
                                    className="w-11 h-11 flex items-center justify-center rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 hover:bg-purple-500 hover:text-white transition-all"
                                >
